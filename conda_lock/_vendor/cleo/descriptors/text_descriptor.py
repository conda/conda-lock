...
from conda_lock._vendor.cleo.descriptors.descriptor import Descriptor
from conda_lock._vendor.cleo.formatters.formatter import Formatter
from conda_lock._vendor.cleo.io.inputs.definition import Definition


if TYPE_CHECKING:
    from conda_lock._vendor.cleo.application import Application
...
class TextDescriptor(Descriptor):
    ...
    def _describe_application(self, application: Application, **options: Any) -> None:
        from conda_lock._vendor.cleo.descriptors.application_description import ApplicationDescription
