...
from conda_lock._vendor.cleo.commands.base_command import BaseCommand
...
from conda_lock._vendor.cleo.ui.table_separator import TableSeparator
...
if TYPE_CHECKING:
    ...
    from conda_lock._vendor.cleo.ui.question import Question
    from conda_lock._vendor.cleo.ui.table import Rows
    from conda_lock._vendor.cleo.ui.table import Table
...
class Command(BaseCommand):
    ...
    def confirm(
        ...
        """
        from conda_lock._vendor.cleo.ui.confirmation_question import ConfirmationQuestion
    ...
    def choice(
        ...
        """
        from conda_lock._vendor.cleo.ui.choice_question import ChoiceQuestion
