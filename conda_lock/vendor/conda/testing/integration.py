...
from conda_lock.vendor.conda.auxlib.compat import Utf8NamedTemporaryFile
from conda_lock.vendor.conda.auxlib.entity import EntityEncoder
from conda_lock.vendor.conda.base.constants import PACKAGE_CACHE_MAGIC_FILE
from conda_lock.vendor.conda.base.context import context, reset_context, conda_tests_ctxt_mgmt_def_pol
from conda_lock.vendor.conda.cli.conda_argparse import do_call
from conda_lock.vendor.conda.cli.main import generate_parser, init_loggers
from conda_lock.vendor.conda.common.compat import encode_arguments, on_win
from conda_lock.vendor.conda.common.io import (
    argv,
    captured,
    dashlist,
    disable_logger,
...
from conda_lock.vendor.conda.common.url import path_to_url, escape_channel_url
from conda_lock.vendor.conda.core.prefix_data import PrefixData
from conda_lock.vendor.conda.core.package_cache_data import PackageCacheData
from conda_lock.vendor.conda.exceptions import conda_exception_handler
from conda_lock.vendor.conda.gateways.disk.create import mkdir_p
from conda_lock.vendor.conda.gateways.disk.delete import rm_rf
from conda_lock.vendor.conda.gateways.disk.link import link
from conda_lock.vendor.conda.gateways.disk.update import touch
from conda_lock.vendor.conda.gateways.logging import DEBUG
from conda_lock.vendor.conda.models.match_spec import MatchSpec
from conda_lock.vendor.conda.models.records import PackageRecord
from conda_lock.vendor.conda.utils import massage_arguments
