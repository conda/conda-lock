...
try:
    ...
    from conda_lock.vendor.conda._vendor.toolz.itertoolz import concat, concatv, unique
    from conda_lock.vendor.conda._vendor.toolz.dicttoolz import merge, merge_with
    from conda_lock.vendor.conda._vendor.toolz import excepts
